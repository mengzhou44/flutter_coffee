...
import 'common_widgets/custom-container.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  String selectedItem = 'All products';
  ...
  Widget _buildTitle() {
    return Padding(
      ...
      child: Text(
        'Starbucks Coffee',
        style: TextStyle(
            fontFamily: 'Raleway', fontSize: 22.0, fontWeight: FontWeight.bold),
      ),
    );
  }
    ...
    return Row(
        ...
        children: <Widget>[
          ...
          Padding(
              ...
              child: Stack(
                children: [
                  CustomContainer(height: 50, width: 50),
                  CustomContainer(
                    height: 40,
                    width: 40,
  ...
  Widget _buildCoffeeItem(String imgPath, String productName, String productType, String price) {
    return Padding(
